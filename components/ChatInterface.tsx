...
export default function ChatInterface({ leadId, onNewMessage }: ChatInterfaceProps) {
  ...
  const greeting = t.greeting || "👋 Hello! I'm your AI-powered B2B sales assistant. I'm here to help you discover the perfect technology solutions for your business. What challenges are you looking to solve today?"
